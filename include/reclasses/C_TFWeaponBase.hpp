...
public:
    ...
    inline static bool CalcIsAttackCriticalHelper_re(IClientEntity *self)
    {
        ...
        int unk1 = *(int *) (reinterpret_cast<intptr_t>(self) + 2832u);
        int unk2 = *(int *) (reinterpret_cast<intptr_t>(self) + 2820u);
        unk2 <<= 6;

        int unk3  = unk1 + unk2 + 1784;
        char unk4 = *(char *) (unk1 + unk2 + 1844);
        if (unk4 && *(float *) (reinterpret_cast<intptr_t>(self) + 2864u) > g_GlobalVars->curtime)
            return true;
    ...
    {
        return *(uint16_t *) (reinterpret_cast<intptr_t>(self) + 2750u);
    }
    inline static float &crit_bucket_(IClientEntity *self)
    {
        return *(float *) (reinterpret_cast<intptr_t>(self) + 2616u);
    }
};
} // namespace re
