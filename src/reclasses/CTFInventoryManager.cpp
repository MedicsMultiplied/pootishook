...
CTFInventoryManager *CTFInventoryManager::GTFInventoryManager()
{
    ...
    static uintptr_t address                            = reinterpret_cast<uintptr_t>(e8call((void *) (gSignatures.GetClientSignature("E8 ? ? ? ? 0F B6 55 0C")) + 1));
...
CEconItemView *CTFPlayerInventory::GetFirstItemOfItemDef(int id)
{
    ...
    static uintptr_t address                                = reinterpret_cast<uintptr_t>(e8call((void *) (gSignatures.GetClientSignature("E8 ? ? ? ? 85 C0 74 35 8B 55 C0")) + 1));
